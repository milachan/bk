...
@include('reports.pdf._base', ['accentColor'=>'#145a32','accentBorder'=>'#0e3d22','accentBg'=>'#eafaf1'])
</head>
<body>

<div class="pdf-header">
    <div class="school">{{ config('app.school_name','SEKOLAH MENENGAH ATAS') }}</div>
    <div class="title">LAPORAN KONSELING SISWA</div>
    <div class="period">
        Periode:
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>@php
                ...
                elseif ($r->counselor_name) $names[] = $r->counselor_name;
                if (!empty($r->extra_counselors)) foreach ($r->extra_counselors as $e) $names[] = $e;
...
@else
<div class="no-data">Tidak ada data konseling untuk filter yang dipilih.</div>
@endif
