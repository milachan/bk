...
<div class="page-header">
    <div><h4><i class="bi bi-exclamation-triangle-fill me-2 text-warning"></i>Tambah Jenis Pelanggaran</h4></div>
        ...
        <div class="row g-3">
            <div class="col-12">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name') }}" placeholder="Contoh: Terlambat masuk kelas" required/>
            ...
            <div class="col-12">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                    rows="3" placeholder="Keterangan tambahan tentang jenis pelanggaran ini...">{{ old('description') }}</textarea>
