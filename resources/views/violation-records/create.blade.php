...
<div class="page-header">
    <div><h4><i class="bi bi-shield-exclamation me-2 text-danger"></i>Input Pelanggaran</h4></div>
    <a href="{{ route('violation-records.index') }}" class="btn btn-light btn-sm"><i class="bi bi-arrow-left me-1"></i> Kembali</a>
</div>

<div class="row justify-content-center">
<div class="col-12 col-lg-8">
<form action="{{ route('violation-records.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-card">
        <div class="row g-3">
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                    rows="3" placeholder="Tuliskan kronologi kejadian...">{{ old('description') }}</textarea>
